  ...
  return (
    <div className="pt-12">
      <footer id="footer" className="relative z-50 pt-24">
        <div className="bg-black border-t border-b border-gray-800 py-16">
          <div className="mx-auto container px-4 xl:px-12 2xl:px-4 justify-center ">
                ...
                <div className="w-full lg:w-1/2 px-6">
                  <ul>
                    <li>
                      <Link
                        to="/"
                        className="text-xs lg:text-sm leading-none hover:text-brand dark:hover:text-brand text-white"
                      >
                        Components
                      </Link>
                    </li>
                ...
                {/* <div className="w-full lg:w-1/2 px-6 flex flex-col justify-between">
                  <div className="flex items-center mb-6">
                    ...
                    <Link to="/">
                      <div className="pl-4">
                        <svg
                          className="footer-icon feather feather-twitter text-white cursor-pointer hover:text-brand dark:hover:text-brand "
                          xmlns="http://www.w3.org/2000/svg"
                          width={24}
                          height={24}
                          viewBox="0 0 24 24"
        ...
        <div className="bg-black py-16 flex flex-col justify-center items-center">
          <Link to="/">
            <svg
          ...
          <p className="mt-6 text-xs lg:text-sm leading-none text-white">
